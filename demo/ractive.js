/*
	...
	Tue Dec 08 2015 15:21:49 GMT-0700 (MST) - commit 9d37f44b7e82aacafd38e011db76512b92ebc8e1
...
var classCallCheck = function (instance, Constructor) {
  ...
  var RepeatedFragment = (function () {
  	...
  	RepeatedFragment.prototype.detach = function detach() {
  		...
  		activeIterations(this.iterations).forEach(function (fragment) {
  	...
  	RepeatedFragment.prototype.rebind = function rebind(context) {
  		...
  		if (context && isArray(context.get())) {
  			activeIterations(this.iterations).forEach(function (fragment, i) {
  	...
  	RepeatedFragment.prototype.toString = function toString(escape) {
  		return this.iterations ? activeIterations(this.iterations).map(escape ? toEscapedString : _toString).join('') : '';
  	};

  	RepeatedFragment.prototype.unbind = function unbind() {
  		activeIterations(this.iterations).forEach(_unbind);
  		return this;
  	};

  	RepeatedFragment.prototype.unrender = function unrender(shouldDestroy) {
  		activeIterations(this.iterations).forEach(shouldDestroy ? unrenderAndDestroy$1 : _unrender);
  	...
  	RepeatedFragment.prototype.updatePostShuffle = function updatePostShuffle() {
  		...
  		for (var _i = newIndices.length; _i < this.previousIterations.length; _i++) {
  			this.previousIterations[_i].unbind().unrender(true);
  		}
